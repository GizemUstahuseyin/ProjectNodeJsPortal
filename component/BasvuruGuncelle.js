            ...
            <center>
                <div className="col-10 align-items-center" style={{color:"black"}}>
                    ...
                    <div style={{paddingTop:"5%",fontSize:"40px"}}><ImAirplane/></div>
                        <form className="was-validated p-5"onSubmit={handleSubmit} novalidate>
                ...
                <h4><label className="form-label form-label-left form-label-auto"><b>ERASMUS PROGRAMI BAŞVURU FORMU</b></label></h4>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-3">
                                    ...
                                    name="isim"
                                    value={isim} 
                                    onChange= {(e) => setIsim(e.target.value)} placeholder={bilgi.isim}/>
                                ...
                                <div className="col-3">
                                    ...
                                    value={soyisim} 
                                    onChange= {(e) => setSoyisim(e.target.value)} placeholder={bilgi.soyisim}/>
                            ...
                            <div className="row p-2">
                                ...
                                <span className="form-address-line form-address-country-line jsTest-address-lineField ">
                                        ...
                                        <select id="cins" name="cins" className="form-select" required
                                            ...
                                            onChange= {(e) => setCinsiyet(e.target.value)}>
                                                <option value="">{bilgi.cinsiyet}</option>
                                ...
                                <div className="col-3">
                                    ...
                                    value={tarih} 
                                    onChange= {(e) => setTarih(e.target.value)} placeholder={bilgi.tarih}/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-3">
                                    <span className="form-address-line form-address-country-line jsTest-address-lineField ">
                                        <span className="form-sub-label-container" style={{verticalAlign:"top", size:"23"}}>
                                            ...
                                            value={milliyet} 
                                            onChange= {(e) => setMilliyet(e.target.value)} placeholder={bilgi.milliyet}>
                                                <option value={bilgi.milliyet}>{bilgi.milliyet}</option>
                                    ...
                                    <span className="form-address-line form-address-country-line jsTest-address-lineField ">
                                        <span className="form-sub-label-container" style={{verticalAlign:"top", size:"23"}}>
                                           ...
                                           onChange= {(e) => setIkinciMilliyet(e.target.value)}>
                                                <option value="">{bilgi.ikinciMilliyet}</option>
...
                                                <option value="Yunan">Yunan</option>
                                ...
                                <div className="col-3">
                                   ...
                                   value={tcNo} 
                                   onChange= {(e) => setTcNo(e.target.value)} placeholder={bilgi.tcNo}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                    ...
                                    <span className="form-address-line form-address-country-line jsTest-address-lineField ">
                                        <span className="form-sub-label-container" style={{verticalAlign:"top", size:"23"}}>
                                           ...
                                           onChange= {(e) => setUlke(e.target.value)}>
                                                <option value="">{bilgi.ulke}</option>
                                ...
                                value={il} 
                                onChange= {(e) => setIl(e.target.value)} placeholder={bilgi.il}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                value={ilce} 
                                onChange= {(e) => setIlce(e.target.value)} placeholder={bilgi.ilce}/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-3">
                                    ...
                                    value={mahalle} 
                                    onChange= {(e) => setMahalle(e.target.value)} placeholder={bilgi.mahalle}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-3">
                                    ...
                                    value={sokak} 
                                    onChange= {(e) => setSokak(e.target.value)} placeholder={bilgi.Street}/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-3">
                                    ...
                                    value={apartno} 
                                    onChange= {(e) => setApartno(e.target.value)} placeholder={bilgi.apartNo}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-3">
                                   ...
                                   value={zip} 
                                   onChange= {(e) => setZip(e.target.value)} placeholder={bilgi.zip}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                <span className="form-address-line form-address-country-line jsTest-address-lineField">
                                    ...
                                    onChange= {(e) => setUniversite(e.target.value)}>
                                        <option value="">{bilgi.universite}</option>
                                ...
                                <div className="col-3">
                                    ...
                                    value={fakulte} 
                                    onChange= {(e) => setFakulte(e.target.value)} placeholder={bilgi.fakulte}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                <option value="">{bilgi.bolum}</option>
                                ...
                                <option value="dis-hekimligi">Diş Hekimliği Fakültesi ve Diş Hekimliği Uzmanlık Programları</option> 
                                        ...
                                        <span className="form-sub-label-container" style={{verticalAlign:"top", size:"23"}}
                                           ...
                                           onChange= {(e) => setMezuniyet(e.target.value)}>
                                            <select name="nationality" className="form-select" id="mezuniyet" required>
                                                <option value="">{bilgi.mezuniyet}</option>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-3">
                                    ...
                                    onChange= {(e) => setMezuniyetTarih(e.target.value)} placeholder={bilgi.mezuniyetTarih}/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-3">
                                    ...
                                    value={not} 
                                    onChange= {(e) => setNot(e.target.value)} placeholder={bilgi.not}/>
                                    <div className="invalid-feedback">
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-6">
                                    <div className="input-group">
                                        ...
                                        <button className="btn btn-outline-secondary" type="button" id="cv" name="cv">Yükle</button>
                                    </div>
                                    <div><span>{bilgi.cv}</span></div>
                                </div>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-6">
                                    <div className="input-group">
                                        ...
                                        value={diploma} 
                                        onChange= {(e) => setDiploma(e.target.value)} placeholder={bilgi.diploma}/>
                                        <button className="btn btn-outline-secondary" type="button" id="btnUpload" name="btnUpload">Yükle</button>
                                    </div>
                                    <div><span>{bilgi.diploma}</span></div>
                                </div>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-6">
                                    <div className="input-group">
                                        ...
                                        value={ingYetkin} 
                                        onChange= {(e) => setIngYetkin(e.target.value)} placeholder={bilgi.ingYetkin}/>
                                        <button className="btn btn-outline-secondary" type="button" id="btnUpload" name="btnUpload">Yükle</button>
                                    </div>
                                    <div><span>{bilgi.ingYetkin}</span></div>
                                </div>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-6">
                                    <div className="input-group">
                                       ...
                                       value={ikametgah} 
                                       onChange= {(e) => setIkametgah(e.target.value)} placeholder={bilgi.ikametgah}/>
                                        <button className="btn btn-outline-secondary" type="button" id="btnUpload" name="btnUpload">Yükle</button>
                                    </div>
                                    <div><span>{bilgi.ikametgah}</span></div>
                                </div>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-6">
                                    <div className="input-group">
                                        ...
                                        value={pasaport} 
                                        onChange= {(e) => setPasaport(e.target.value)} placeholder={bilgi.pasaport}/>
                                        <button className="btn btn-outline-secondary" type="button" id="btnUpload" name="btnUpload">Yükle</button>
                                    </div>
                                    <div><span>{bilgi.pasaport}</span></div>
                                </div>
                            ...
                            <div className="row p-2">
                                ...
                                <div className="col-3">
                                    ...
                                    value={telefon} 
                                    onChange= {(e) => setTelefon(e.target.value)} placeholder={bilgi.telefon}/>
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-3">
                                <input class="form-control" type="email" name="email" id="email" placeholder={bilgi.email} value={email} />
